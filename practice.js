/* ==========================================================================
   1. WORD & SENTENCE POOLS (Full Database Copy)
   ========================================================================== */
...
const banglaSentences = [
    ...
    ["প্রযুক্তির", "সঠিক", "ব্যবহার", "আমাদের", "জীবনকে", "অনেক", "सहজ", "ও", "সুন্দর", "করেছে।"],
    ...
    ["পরনিন্দা", "করা", "ভালো", "নয়", "নিজের", "কাজের", "प्रति", "মনোযোগী", "হওয়া", "উচিত।"],
    ...
    ["নদীর", "কলকল", "ধ্বনি", "শুনলে", "সব", "ক্লান্তি", "নিমেষেই", "দূর", "হয়ে", "যায়।"],
    ["আজকের", "শিশু", "আগামী", "দিনের", "ভবিষ্যত", "তাদের", "সঠিকভাবে", "গড়ে", "তুলতে", "হবে।"],
    ["একতাই", "বল", "সবাই", "মিলে", "মিশে", "থাকলে", "যেকোনো", "কাজ", "সহজ", "হয়।"],
    ...
    ["কঠিন", "অধ্যবসায়", "ছাড়া", "জীবনে", "কোনো", "বড়", "সাফল্য", "অর্জন", "করা", "যায়না।"],
    ["ছোটদের", "স্নেহ", "করুন", "এবং", "বড়দের", "সবসময়", "যথাযথ", "সম্মান", "প্রদর্শন", "করুন।"],
    ["অলসতা", "মানুষের", "সবচেয়ে", "বড়", "শত্রু", "যা", "জীবনকে", "ধ্বংসের", "দিকে", "নিয়ে।"],
    ["নিয়মাবর্তিতা", "মেনে", "চললে", "যেকোনো", "কাজে", "সফলতা", "আসা", "একদম", "নিশ্চিত।"],
    ["কৃষক", "আমাদের", "অন্ন", "জোগান", "তাই", "তাদের", "কখনো", "ছোট", "করে", "দেখা।"],
    ["সুন্দর", "ব্যবহার", "দিয়ে", "শত্রুকেও", "সহজে", "আপন", "করে", "নেওয়া", "সম্ভব।"],
    ["لوভে", "পাপ", "পাপে", "মৃত্যু", "এই", "চিরন্তন", "সত্যটি", "কখনো", "ভুলবেন।"],
    ...
    ["মনোযোগ", "সহকারে", "পড়ালেখা", "করলে", "পরীক্ষায়", "ভালো", "ফলাফল", "করা", "সহজ।"],
    ...
    ["সূর্য", "পূর্ব", "দিকে", "ওঠে", "এবং", "পশ্চিম", "দিকে", "অস্ত", "যায়", "নিয়মিত।"],
    ...
    ["সাফল্যের", "কোনো", "সংক্ষিপ্ত", "পথ", "নেই", "কঠোর", "পরিশ্রমই", "একমাত্র", "উপায়।"],
    ...
    ["মনকে", "সবসময়", "প্রফুল্ল", "রাখুন", "এতে", "শরীরের", "অনেক", "অসুখ", "ভালো", "হয়।"],
    ["সৎ", "সঙ্গে", "স্বর্গবাস", "অসৎ", "সঙ্গে", "সর্বনাশ", "কথাটি", "বাস্তবে", "সত্য।"],
    ["জ্ঞানের", "কোনো", "সীমা", "নেই", "যত", "পড়বেন", "তত", "নতুন", "কিছু", "শিখবেন।"],
    ["প্রকৃতি", "আমাদের", "অনেক", "কিছু", "দেয়", "তাই", "প্রকৃতির", "যত্ন", "নেওয়া", "উচিত।"],
    ["কষ্ট", "বিনা", "কেষ্ট", "মেলে", "না", "তাই", "জীবনে", "কষ্ট", "করতে", "হবে।"],
    ["পানির", "অপর", "নাম", "জীবন", "তাই", "বিশুদ্ধ", "পানি", "পান", "করা", "জরুরি।"],
    ["সহযোগিতার", "হাত", "বাড়িয়ে", "দিলে", "যেকোনো", "কঠিন", "সমস্যা", "সহজে", "সমাধান", "হয়।"],
    ["ভালো", "বই", "মানুষের", "শ্রেষ্ঠ", "সঙ্গী", "যা", "কখনো", "বিপদে", "ছেড়ে", "যায়না।"],
    ["ছোট", "ছোট", "বালুকণা", "বিন্দু", "বিন্দু", "জল", "গড়ে", "তোলে", "মহাদেশ", "অতল।"],
    ["মিষ্টি", "কথা", "বলে", "মানুষের", "মন", "সহজে", "জয়", "করা", "সম্ভব", "সবসময়।"],
    ["অন্যায়ের", "প্রতিবাদ", "করা", "আমাদের", "সবার", "নৈতিক", "দায়িত্ব", "ও", "কর্তব্য।"],
    ["পাখিরা", "মুক্ত", "আকাশে", "ডানা", "মেলে", "উড়ে", "বেড়াতে", "খুব", "ভালোবাসে।"],
    ["আইন", "মেনে", "চলা", "সচেতন", "নাগরিকের", "প্রধান", "লক্ষণ", "ও", "বৈশিষ্ট্য।"],
    ["নিয়মিত", "ডায়েরি", "লিখলে", "নিজের", "ভুলত্রুটি", "সহজে", "ধরে", "ফেলা", "সম্ভব", "হয়।"],
    ["হতাশ", "হবেন", "না", "আল্লাহর", "উপর", "সবসময়", "দৃঢ়", "বিশ্বাস", "রাখুন।"],
    ["সময়ের", "এক", "ফোঁড়", "অসময়ের", "দশ", "Cons", "কাজ", "সময়মতো", "করা", "উচিত।"],
    ...
    ["চলক", "এবং", "ধ্রুবক", "এর", "ব্যবহার", "গণিতে", "প্রচুর", "পরিমাণে", "দেখা", "যায়।"],
    ...
    ["ব্যাকরণ", "সঠিকভাবে", "না", "জানলে", "ভাষা", "শুদ্ধভাবে", "বলা", "বা", "লেখা", "যায়না।"],
    ...
    ["পরিবার", "আমাদের", "সবচেয়ে", "নিরাপদ", "আশ্রয়স্থল", "যেখানে", "আমরা", "বড়", "হই।"],
    ["ভবিষ্যতের", "পরিকল্পনা", "এখনই", "ঠিক", "করে", "নিয়ে", "কাজ", "শুরু", "করা", "উচিত।"],
    ["গ্রামের", "শান্ত", "পরিবেশ", "মনকে", "নিমেষেই", "ভালো", "করে", "দিতে", "পারে।"],
    ["বিজয়", "দিবস", "আমাদের", "গৌরবের", "দিন", "এই", "দিনটিকে", "শ্রদ্ধা", "জানাই।"],
...
function initPractice(mode) {
    ...
    // Generates a smooth, endless block of 30 layout entries to loop over
...
hiddenInput.addEventListener("input", (e) => {
    ...
    if (wordIndex >= currentWords.length) {
        initPractice(isBanglaMode ? "bn" : "en");
    } else {
        markCurrentChar();
    }
});
...
/* ==========================================================================
   7. VISUAL KEYBOARD SYNCHRONIZATION WITH SYMBOL PATTERNS
   ========================================================================== */
...
/* ==========================================================================
   8. GLOBAL APPLICATION EVENT HANDLERS
   ========================================================================== */
wordsDisplay.addEventListener("click", () => { hiddenInput.focus(); });
btnEn.addEventListener("click", () => { btnEn.classList.add("active"); btnBn.classList.remove("active"); initPractice("en"); });
btnBn.addEventListener("click", () => { btnBn.classList.add("active"); btnEn.classList.remove("active"); initPractice("bn"); });
restartBtn.addEventListener("click", () => initPractice(isBanglaMode ? "bn" : "en"));

// Boot system workspace automatically
initPractice("en");